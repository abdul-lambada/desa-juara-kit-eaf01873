...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        ...
        <a href="/kategori-berita/create" class="btn btn-sm btn-primary">
                ...
                <?php else: ?>
                    <?php foreach ($pagination['data'] as $index => $kategori): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/kategori-berita/<?= $kategori['id'] ?>/edit" class="btn btn-sm btn-outline-warning"><i class="fas fa-edit"></i></a>
                                <form action="/kategori-berita/<?= $kategori['id'] ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini?');">
